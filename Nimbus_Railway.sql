...
--
-- Hôte : localhost:8889
-- Généré le : ven. 21 fév. 2025 à 14:14
...
--
-- Structure de la table `Trajet_eleve`
--

CREATE TABLE `Trajet_eleve` (
  `id` int(11) NOT NULL,
  `id_élève` int(11) DEFAULT NULL,
...
--
-- Index pour la table `Trajet_eleve`
--
ALTER TABLE `Trajet_eleve`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT pour la table `Trajet_eleve`
--
ALTER TABLE `Trajet_eleve`
...
--
-- Contraintes pour la table `Trajet_eleve`
--
ALTER TABLE `Trajet_eleve`
  ADD CONSTRAINT `trajet_eleve_ibfk_1` FOREIGN KEY (`id_élève`) REFERENCES `Eleve` (`id`),
  ADD CONSTRAINT `trajet_eleve_ibfk_2` FOREIGN KEY (`id_trajet`) REFERENCES `Trajet` (`id`);
COMMIT;
